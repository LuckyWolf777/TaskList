...
import com.task.tasklist.model.exception.ResourceMappingException;
import com.task.tasklist.model.user.Role;
import com.task.tasklist.model.user.User;
import com.task.tasklist.repository.DataSourceConfig;
import com.task.tasklist.repository.UserRepository;
import com.task.tasklist.repository.mappers.UserRowMapper;
...
public class UserRepositoryImp implements UserRepository {
    ...
    private final String INSERT_USER_ROLE = """
            INSERT UNTO users_roles (user_id, role)
            VALUES (?,?)
            """;
